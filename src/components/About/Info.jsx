...
function Info() {
  ...
  return (
    <div className="my-(--html-spacing) section-padding grid grid-cols-1 md:grid-cols-2 lg:grid-cols-9 gap-8 lg:gap-10">
      <div className="md:col-span-1 lg:col-span-6 flex flex-col gap-4" data-aos="fade-up">
        <video
          src={Images.video}
          autoPlay
          loop
      ...
      <div className="md:col-span-1 lg:col-span-3 flex flex-col" data-aos="fade-up" data-aos-delay="100">
        <img
